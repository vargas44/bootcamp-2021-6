...
public class PagePaquetes extends SeleniumBaseE5 {
    ...
    //prueba
    By prueba2 = By.xpath("//input[@class='input-tag sbox-main-focus sbox-origin sbox-primary sbox-places-first sbox-origin-container places-inline']");
    By prueba = By.xpath("//span[.='Rio de Janeiro, Rio de Janeiro, Brasil']");
